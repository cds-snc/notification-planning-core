...
- [ ] [e.g., ADR (Architecture Decision Record) updated]
...
**XP Note:** If the timebox expires before the question is answered, stop work, share what was learned, and decide whether to schedule a second spike or pivot.